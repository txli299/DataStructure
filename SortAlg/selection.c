// Compile with: gcc -g selection.c -o selection
// Run with: ./selection
...
void sortIntegers(int* array, unsigned int size){
  ...
  for(i=0; i < size -1; i++){
    // printf("%d\n",i);
    // printf("%d\n",array[i]);
    // printf("%d\n",findMinimum(array, 1, size));
    // printf("%d\n",array[findMinimum(array, 1, size)]);
    
    if(array[findMinimum(array, i, size)]<array[i]){
      //printf("%d\n",i);
      swap(&array[i],&array[findMinimum(array, i, size)]);
    }
  }
...
// printf("%d\n",findMinimum(dataset2, 0, 11));
// printf("%d\n",dataset2[findMinimum(dataset2, 0, 11)]);
// swap(&dataset2[0],&dataset2[10]);
// printIntArray(dataset2, 11);
// printf("%d\n",findMinimum(dataset2, 1, 11));

 //printf("%d\n",findMinimum(dataset2, 2, 11));
